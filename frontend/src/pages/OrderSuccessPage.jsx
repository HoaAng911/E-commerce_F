...
const OrderSuccessPage = () => {
  ...
  const displayId = currentOrder?.orderCode || orderId;
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 bg-white">
      ...
      {/* Thông báo */}
      <h1 className="mb-4 text-2xl font-bold tracking-widest uppercase text-center">Đặt hàng thành công!</h1>
      <p className="max-w-md mb-8 text-sm leading-relaxed text-center text-gray-500">
        Cảm ơn bạn đã tin tưởng chọn Shoes Store. Đơn hàng của bạn <span className="font-bold text-black">#{displayId}</span> đang được xử lý và sẽ sớm được giao đến bạn.
      </p>
